...
def parse_args():
    ...
    parser.add_argument('--config',
                        default='/data2/hyb/SegNetwork_other/SegNeXt-main/'
                                'tools/work_dirs/segnext_base/segnext_dy_ham_bgh_mils.py',
                        help='test config file path')
    parser.add_argument('--checkpoint',
                        default='/data2/hyb/SegNetwork_other/SegNeXt-main/'
                                'tools/work_dirs/segnext_base/segnext_dy_ham_bgh_mils/best_mIoU_epoch_94.pth',
